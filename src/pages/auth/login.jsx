    ...
    <AuthLayout>
      <div className='bg-white rounded-3xl border border-[#E8E6E1] shadow-[0_8px_30px_rgba(26,26,24,0.04)] p-8 sm:p-10'>
        <div className='mb-8 text-center'>
          <h2 className='text-2xl font-bold text-[#1A1A18] tracking-tight'>
            Selamat Datang
          </h2>
          <p className='text-sm text-[#6B6860] mt-1.5'>
            Masuk ke dashboard manajemen operasional Anda.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
          ...
          <div className='flex items-center justify-between mt-1'>
            <label className='flex items-center gap-2 cursor-pointer group'>
              ...
              />
              <span className='text-sm text-[#6B6860] group-hover:text-[#1A1A18] transition-colors'>
                Ingat sesi saya
              </span>
            </label>
            <button
              type='button'
              className='text-sm text-[#3A6B1C] hover:text-[#2D5016] font-medium transition-colors'
            >
              Lupa sandi?
            </button>
          </div>
        ...
        <p className='text-center text-sm text-[#6B6860] mt-8'>
          ...
          <Link
            to='/register'
            className='text-[#3A6B1C] font-semibold hover:text-[#2D5016] transition-colors'
          >
            Hubungi Admin
          </Link>
        </p>
