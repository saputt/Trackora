...
import VehiclePickerModal from "../../components/organisms/VehiclePickerModal";
...
function HealthBar({ score }) {
  return (
    <div className='flex items-center gap-2'>
      ...
      <span className='text-xs font-semibold text-[#1A1A18] w-8 text-right tabular-nums'>
        {score}
      </span>
    </div>
  );
      ...
      <div className='max-w-[1400px] mx-auto space-y-6'>
        ...
        <motion.div initial='hidden' animate='visible' variants={fadeUp}>
          <div className='flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-2'>
            <div>
              <h2 className='text-[28px] font-bold text-[#1A1A18] tracking-tight'>
                Selamat Datang, Budi 👋
              </h2>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 gap-6'>
          ...
          <div className='lg:col-span-3 space-y-6'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
              ...
              >
                <StatCard
                  ...
                  value={(summary?.warning || 0) + (summary?.critical || 0)}
            ...
            <div className='grid md:grid-cols-2 gap-6'>
              ...
              >
                ...
                >
                  <SectionHeader
                    ...
                    subtitle='Skor kesehatan rata-rata armada'
                  />
              ...
              >
                <Card className='h-full' padding='lg'>
                  <SectionHeader
                    title='Tren Pemeliharaan'
                    subtitle='6 bulan riwayat'
                  />
            ...
            >
              <Card padding='lg'>
                <SectionHeader
                  title='Titik Kerusakan Armada'
                  subtitle='Komponen paling sering mengalami masalah'
                />
                <div className='pt-2'>
                  {chartsLoading ? (
                    ...
                    <ResponsiveContainer width='100%' height={240}>
                      <BarChart
                        data={charts?.componentDistribution || []}
                        margin={{ left: -20, right: 0, top: 10, bottom: -10 }}
                      >
                        <CartesianGrid
                          strokeDasharray='3 3'
                          stroke='#F0EDE8'
                        ...
                        <Bar
                          ...
                          radius={[4, 4, 0, 0]}
                        >
                          {charts?.componentDistribution?.map(
                            (entry, index) => (
                              <Cell
                                key={`cell-${index}`}
                                fill={
          ...
          <div className='space-y-6'>
            ...
            >
              <Card padding='md' className='bg-[#3A6B1C] border-[#2D5016]'>
                <h3 className='text-white font-semibold mb-4 text-[15px]'>
                  Tindakan Cepat
                </h3>
                <div className='space-y-2'>
                  <button
                    onClick={() => setVehiclePickerOpen(true)}
                    className='w-full flex items-center justify-between p-3 rounded-xl bg-white/10 hover:bg-white/20 transition-colors text-left group border border-white/5'
                  >
                ...
                <div className='space-y-3'>
                  {vLoading ? (
                    Array.from({ length: 4 }).map((_, i) => (
                      <div
                        key={i}
                        className='h-14 bg-[#F7F6F3] rounded-xl animate-pulse'
                      />
                    ))
                    ...
                    <div className='py-8 text-center bg-[#EEF7EE] rounded-xl border border-[#C4DFB0]'>
                      ...
                      <p className='text-sm font-medium text-[#3D7A3A]'>
                        Semua Normal
                      </p>
                    </div>
                  ) : (
